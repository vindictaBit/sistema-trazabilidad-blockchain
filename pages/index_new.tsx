...
export default function Home() {
    ...
    reader.onload = (e) => {
      ...
      img.onload = () => {
        ...
        if (code && code.data) {
          ...
          setErrorMessage('No se detectó código QR en la imagen. Intente con una imagen más clara.');
          setStatus('error');
        }
      };
  ...
  }, [isConfirming, isConfirmed, hash, isWriteError, writeError, status]);
          ...
          <div className="card mb-8">
            ...
            {!mounted ? (
              ...
              <div className="space-y-4">
                ...
                {/* SOLUCIONADO: Solo mostrar UN botón */}
                {connectors.length > 0 && (
                  <button
